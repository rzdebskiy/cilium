            ...
            steps {
                ...
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:e624fb76b6cb19e888bf8ddd1e34c3082d2c1b04@sha256:0b645037029870a132b7e3b6aee2458367b367578ff99dc5782855fcc35739de"
                    }
                }
            }
        }
